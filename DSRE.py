...
# v1.17: 高層 decay 補正 (v1.13/v1.14 互換の 1.5x 一律段差)
HARMONIC_HIGH_LAYER_BOOST = 1.5
# v1.17: v1.15 の path 単位 sosfilt tilt と v1.16 の FFT 最終 EQ
# (apply_master_monotonizer) は破壊源 (位相歪・ノイズ・補完悪化) として完全除去。
# 後段強制矯正は使わず、純粋加算 (v1.14 同等) のみで自然なスペクトルを返す。
...
class DSREParams:
    ...
    # v1.17: 高層 decay 補正 (1.5x 一律、v1.13/v1.14 互換)
